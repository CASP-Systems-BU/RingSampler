# Refer to code:
# https://github.com/gsampler9/gSampler/blob/main/examples/utils/gen_graph_from_txt.py

# this file takes raw txt graph edge file as input, and convert to sparse graph in binary format
# if the graph is undirected, remember to set the --to-bidirected flag 
...
def gen_graph_from_text(txt_path: str, to_bidirected: bool = False):
    ...
    if to_bidirected:
        print("Converting to bi-directional...")
        g = dgl.to_bidirected(g)

    print("Simplifying the graph...")
    g = dgl.to_simple(g)

    print("Compacting the graph...")
